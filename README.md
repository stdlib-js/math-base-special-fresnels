...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/math-base-special-fresnels/tags). For example,

```javascript
fresnels = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fresnels@v0.3.0-umd/browser.js' )
```
