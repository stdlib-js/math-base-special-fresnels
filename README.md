...
```javascript
import fresnels from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-fresnels@v0.3.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-fresnels/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/math-base-special-fresnels/actions/workflows/test.yml?query=branch:v0.3.1
